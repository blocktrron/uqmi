...
#define wda_helptext \
		...
		"    --dl-datagram-max-count <size>:		Set downlink aggregation max datagrams (number)\n" \
		"    --dl-datagram-max-size <size>:		Set downlink aggregation max datagram size (number)\n" \
		"    --ul-aggregation-protocol <proto>:		Set uplink aggregation protocol (proto: tlp|qc-cm|mbim|rndis|qmap|qmapv5)\n" \
		"    --ul-datagram-max-count <size>:		Set uplink aggregation max datagrams (number)\n" \
		"    --ul-datagram-max-size <size>:		Set uplink aggregation max datagram size (number)\n" \
