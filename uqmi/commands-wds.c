...
static enum qmi_cmd_result
cmd_wds_get_profile_list_prepare(struct qmi_dev *qmi, struct qmi_request *req, struct qmi_msg *msg, char *arg)
{
...
static enum qmi_cmd_result
cmd_wds_set_default_profile_prepare(struct qmi_dev *qmi, struct qmi_request *req, struct qmi_msg *msg, char *arg) {
	struct uqmi_wds_profile_identifier profile;
...
static enum qmi_cmd_result
cmd_wds_set_lte_attach_pdn_prepare(struct qmi_dev *qmi, struct qmi_request *req, struct qmi_msg *msg, char *arg)
{
	uint16_t list[8] = {0};
